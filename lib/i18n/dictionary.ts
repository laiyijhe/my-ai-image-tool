...
export const dictionary: Record<Locale, Messages> = {
  en: {
    ...
    toastProtectReady: "Your protected PNG is downloading.",
  ...
  "zh-TW": {
    ...
    toastProtectReady: "受保護的 PNG 正在下載。",
  ...
  "zh-CN": {
    ...
    toastProtectReady: "受保护的 PNG 正在下载。",
  ...
  ja: {
    ...
    toastProtectReady: "保護済み PNG をダウンロードしています。",
  ...
  ko: {
    ...
    toastProtectReady: "보호된 PNG가 다운로드됩니다.",
